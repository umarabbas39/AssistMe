...
class ReminderActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Tick button will be hide at start and ehrn we change text it will be shown and mic will be hide
        ...
        //when text changes, show tick button and hide mic buton
        ...
        //add data to database when clicked on tick button it will be quick task
        ...
        //Obsering liveData when changes, then change data in recycler view
...
//                Log.d("test","$it setTask() called")
    ...
    //getting data from add activity and inserting in database
