...
class AddReminderActivity : AppCompatActivity() {
    ...
    //when clicked on tick button, data will be sent to previous activity and this activity will be closed
    ...
    //getting time from dialogue and setting in edit text after formatting
